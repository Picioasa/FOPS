...
extension NSMutableAttributedString {
  ...
  static func attributedText(_ string: String, weight: UIFont.Weight = UIFont.Weight.light, and string2: String = "", weight2: UIFont.Weight = UIFont.Weight.regular) -> NSMutableAttributedString {
